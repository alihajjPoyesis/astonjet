...
function enqueue_custom_scripts()
{
	...
	wp_enqueue_script('custom-js-two', get_template_directory_uri() . '/assets/js/custom-two.js', array(), null, true);
	wp_enqueue_style('style-two', get_stylesheet_directory_uri() . '/assets/css/style-two.css', array());
	wp_enqueue_style('owl-carousel', get_stylesheet_directory_uri() . '/assets/css/owl.carousel.min.css', array(), '2.3.4');
	wp_enqueue_style('owl-theme-default', get_stylesheet_directory_uri() . '/assets/css/owl.theme.default.min.css', array(), '2.3.4');
